  ...
  return (
    <>
      ...
      <div className="wrapper container ">
        <div className={`${styles["skills-section"]} flex justify-center items-center`}>
            ...
            <h4 className="text-[#BA324F] text-[1.3rem] font-bold mb-3">
              ...
              <div className="py-3 flex gap-5">
                ...
                <div>
                 ...
                 <h4 className="mt-3">Keterampilan Teknologi</h4>
                </div>
                ...
                <div>
                  ...
                  <h4 className="mt-3">Desain Grafis Dengan Affinity Designer</h4>
...
<p className="mt-3">Saya seorang desainer grafis dengan pengalaman 5 tahun dalam membuat konten visual. Saya ingin membantu Anda memahami dasar-dasar desain dan cara menggunakan alat seperti Adobe Illustrator dan Photoshop</p>
              ...
              <div className="py-3 gap-5">
                ...
                <div>
                  <label
                    className="text-[#04395E] font-semibold"
                    htmlFor="skillsswap">
Keterampilan yang Dicari untuk Ditukar                  </label>
<p className="mt-3">- Fotografi
- Penulisan Konten Kreatif</p>
                </div>
              </div>
              ...
              <div className="py-3 flex gap-5">
                ...
                <div>
                  ...
                  <p className="mt-3">Sabtu - Minggu, Pukul : 13:00 - 17:00</p>
                </div>
              ...
              <div className="flex justify-center flex-col items-center my-8">
                <p className="text-[#BA324F] text-center">Tertarik dengan Keterampilan Ini? </p>
                <p  className="text-[#BA324F] text-center">Segera ajukan pertukaran dan mulai belajar Desain Grafis bersama Rina A. Pilih keterampilanmu, ajukan jadwal, dan lakukan pertukaran untuk saling berbagi pengetahuan!</p>
