          ...
          <div className={`${styles["skills-card"]}`}>
            ...
            border-2 border-x-[#BA324F] border-t-[#BA324F] border-b-0`}>
                <div className={`flex justify-between `}>
                  <div className={`flex flex-col gap-1`}>
                    <h4 className="text-[1rem]">
                      Nama Mitra : <span className="text-[#BA324F] font-bold text-[1rem]">{list.fullname_requester}</span>
                    </h4>
                ...
                <div className={`mt-3 flex gap-3 flex-col `}>
                  ...
                  <p className="font-[400]">
                   Keterampilan yang Ditawarkan : <span className="text-[#BA324F]">{list.skillswapDesc}</span>
                  </p>
                  <p className="font-[400]">
              ...
              <div
                ...
                <button className="lg-btn-secondary">Konfirmasi</button>
              </div>
            </div>
        </>
    )
